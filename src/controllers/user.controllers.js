...
const loginUser = asyncHandler(async(req,res) => {
    ...
    const {refreshToken,acessToken} = await generateAcessAndRefreshToken(user._id)
...
const refreshAccessToken = asyncHandler(async(req,res) => {
    ...
    try {
        ...
        return res.status(200).cookie("acessToken",acessToken,options).cookie("newRefreshToken",newRefreshToken,options)
        .json(
            new ApiResponse (
                200,
...
const changeCurrentPassword = asyncHandler(async(req,res) => {
  ...
  return res.status(200).json(200,{},"Paswword changed success")
})
